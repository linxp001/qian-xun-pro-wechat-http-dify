...
TARGET_WXID = "48683142917@chatroom"
...
if __name__ == '__main__':
    ...
    logger.info(f"监听地址: http://0.0.0.0:5000/webhook")
    logger.info(f"健康检查: http://0.0.0.0:5000/health")
    logger.info(f"测试接口: http://0.0.0.0:5000/test")
